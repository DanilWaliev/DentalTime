  ...
  return `   <div class="doctor-card-top">
             ...
             <div class="doctor-services">
               ...
               <div class="doctor-actions">
                 <a href="/appointment?doctorId=${doctor.id}#step-3" class="btn btn-secondary btn-sm btn-full" data-action="select" data-id="${doctor.id}">Записаться к врачу</a>
               </div>  
           </div>`;
}
...
function generateServiceCard(service) {
  return `
    ...
    <div class="service-card-footer">
        ...
        <a href="/appointment?serviceId=${service.id}#step-2" class="btn btn-primary btn-sm btn-full" data-action="select" data-id="${service.id}">Записаться</a>
    </div>
  `;
}
